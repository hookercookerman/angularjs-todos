(function(s,L,E){function k(a,b,c){var d;if(a)if(m(a))for(d in a)d!="prototype"&&d!=Xb&&d!=Yb&&a.hasOwnProperty(d)&&b.call(c,a[d],d);else if(a.forEach&&a.forEach!==k)a.forEach(b,c);else if(I(a)&&ma(a.length))for(d=0;d<a.length;d++)b.call(c,a[d],d);else for(d in a)b.call(c,a[d],d);return a}function Ha(a,b,c){var d=[],e;for(e in a)d.push(e);d.sort();for(e=0;e<d.length;e++)b.call(c,a[d[e]],d[e]);return d}function Ia(a){if(a instanceof K)a.stack?a=a.stack:a.sourceURL&&(a=a.message+"\n"+a.sourceURL+":"+
a.line);return a}function n(a){k(arguments,function(b){b!==a&&k(b,function(b,d){a[d]=b})});return a}function Zb(a,b){return n(new (n(function(){},{prototype:a})),b)}function q(){}function Z(a){return a}function ua(a){return function(){return a}}function P(a,b,c){var d;return a[b]||(d=a[b]=function(a,b,g){a=(c||Z)(a);x(b)&&(d[a]=n(b,g||{}));return d[a]})}function z(a){return typeof a==$}function x(a){return typeof a!=$}function I(a){return a!=null&&typeof a==gb}function w(a){return typeof a==$b}function ma(a){return typeof a==
ac}function Q(a){return a instanceof Array}function m(a){return typeof a==R}function ia(a){return w(a)?a.replace(/^\s*/,"").replace(/\s*$/,""):a}function Ja(a,b){this.html=a;this.get=D(b)=="unsafe"?ua(a):function(){var b=[];hb(a,ib(b));return b.join("")}}function bc(a,b,c){var d=[];k(a,function(a,f,g){d.push(b.call(c,a,f,g))});return d}function jb(a,b){var c=0,d;if(Q(a)||w(a))return a.length;else if(I(a))for(d in a)(!b||a.hasOwnProperty(d))&&c++;return c}function kb(a,b){for(var c=0;c<a.length;c++)if(b===
a[c])return!0;return!1}function na(a,b){for(var c=0;c<a.length;c++)if(b===a[c])return c;return-1}function cc(a){if(a)switch(a.nodeName){case "OPTION":case "PRE":case "TITLE":return!0}return!1}function A(a,b){if(b)if(Q(a)){for(;b.length;)b.pop();for(var c=0;c<a.length;c++)b.push(A(a[c]))}else for(c in k(b,function(a,c){delete b[c]}),a)b[c]=A(a[c]);else(b=a)&&(Q(a)?b=A(a,[]):a instanceof Date?b=new Date(a.getTime()):I(a)&&(b=A(a,{})));return b}function oa(a,b){if(a==b)return!0;if(a===null||b===null)return!1;
var c=typeof a,d;if(c==typeof b&&c=="object")if(a instanceof Array){if((c=a.length)==b.length){for(d=0;d<c;d++)if(!oa(a[d],b[d]))return!1;return!0}}else{c={};for(d in a){if(d.charAt(0)!=="$"&&!m(a[d])&&!oa(a[d],b[d]))return!1;c[d]=!0}for(d in b)if(!c[d]&&d.charAt(0)!=="$"&&!m(b[d]))return!1;return!0}return!1}function dc(a){return(a=a&&a[0]&&a[0].nodeName)&&a.charAt(0)!="#"&&!kb(["TR","COL","COLGROUP","TBODY","THEAD","TFOOT"],a)}function aa(a,b,c){for(var d;!dc(a);)if(d=a.parent(),d.length)a=a.parent();
...
"false"||a=="no"||a=="n"||a=="[]")):a=!1;return a}function lb(a){return(new mb(Ka,nb,B,J)).compile(a)}function La(a){var b={},c,d;k((a||"").split("&"),function(a){a&&(c=a.split("="),d=unescape(c[0]),b[d]=x(c[1])?unescape(c[1]):!0)});return b}function ob(a){var b=[];k(a,function(a,d){b.push(escape(d)+(a===!0?"":"="+escape(a)))});return b.length?b.join("&"):""}function Ma(a,b){return encodeURIComponent(a).replace(/%40/gi,"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(b?null:
/%20/g,"+")}function ec(a,b){pb();var c=a.getElementsByTagName("script"),d;b=n({ie_compat_id:"ng-ie-compat"},b);for(var e=0;e<c.length;e++)if(d=(c[e].src||"").match(fc))b.base_url=d[1],b.ie_compat=d[1]+"angular-ie-compat"+(d[2]||"")+".js",n(b,La(d[6])),va(o(c[e]),function(a,c){/^ng:/.exec(c)&&(c=c.substring(3).replace(/-/g,"_"),b[c]=a||!0)});return b}function pb(){(Na=s.jQuery)?(o=Na,n(Na.fn,{scope:qb.scope})):o=Oa;u.element=o}function rb(a,b,c){if(!a)throw a=new K("Argument '"+(b||"?")+"' is "+(c||
"required")),s.console&&s.console.log(a.stack),a;}function M(a,b){var c=[];Pa(c,a,b?"\n  ":null,[]);return c.join("")}function ca(a,b){function c(a){if(w(a)&&a.length===sb)return Qa.toDate(a);else(Q(a)||I(a))&&k(a,function(b,d){a[d]=c(b)});return a}if(!w(a))return a;var d,e,f;try{if(b&&s.JSON&&s.JSON.parse)return d=JSON.parse(a),c(d);e=da(a,!0);f=e.primary();e.assertAllConsumed();return f()}catch(g){throw gc("fromJson error: ",a,g),g;}}function Pa(a,b,c,d){if(I(b)){if(b===s){a.push("WINDOW");return}if(b===
L){a.push("DOCUMENT");return}if(kb(d,b)){a.push("RECURSION");return}d.push(b)}if(b===null)a.push(wa);else if(b instanceof RegExp)a.push(u.String.quoteUnicode(b.toString()));else if(m(b))return;else if(typeof b==hc)a.push(""+b);else if(ma(b))isNaN(b)?a.push(wa):a.push(""+b);else if(w(b))return a.push(u.String.quoteUnicode(b));else if(I(b))if(Q(b)){a.push("[");for(var e=b.length,f=!1,g=0;g<e;g++){var h=b[g];f&&a.push(",");!(h instanceof RegExp)&&(m(h)||z(h))?a.push(wa):Pa(a,h,c,d);f=!0}a.push("]")}else if(b instanceof
Date)a.push(u.String.quoteUnicode(u.Date.toString(b)));else{a.push("{");c&&a.push(c);e=!1;f=c?c+"  ":!1;g=[];for(h in b)b[h]!==E&&g.push(h);g.sort();for(h=0;h<g.length;h++){var i=g[h],j=b[i];typeof j!=R&&(e&&(a.push(","),c&&a.push(c)),a.push(u.String.quote(i)),a.push(":"),Pa(a,j,f,d),e=!0)}a.push("}")}I(b)&&d.pop()}function Ra(a){this.paths=[];this.children=[];this.inits=[];this.priority=a;this.newScope=!1}function mb(a,b,c,d){this.markup=a;this.attrMarkup=b;this.directives=c;this.widgets=d}function tb(a,
b){var c,d=a[0].childNodes||[],e;for(c=0;c<d.length;c++){var f=e=d[c];pa(f)=="#text"||b(o(e),c)}}function va(a,b){var c,d=a[0].attributes||[],e,f,g={};for(c=0;c<d.length;c++)e=d[c],f=e.name,e=e.value,S&&f=="href"&&(e=decodeURIComponent(a[0].getAttribute(f,2))),g[f]=e;Ha(g,b)}function qa(a,b,c){if(!b)return a;for(var d=b.split("."),e,f=a,g=d.length,h=0;h<g;h++){e=d[h];if(!e.match(/^[\$\w][\$\w\d]*$/))throw"Expression '"+b+"' is not a valid expression for accesing variables.";a&&(f=a,a=a[e]);if(z(a)&&
e.charAt(0)=="$"){var i=u.Global.typeOf(f);if(e=(i=u[i.charAt(0).toUpperCase()+i.substring(1)])?i[[e.substring(1)]]:E)return a=F(f,e,f)}}if(!c&&m(a))return F(f,a);return a}function Sa(a,b,c){b=b.split(".");for(var d=0;b.length>1;d++){var e=b.shift(),f=a[e];f||(f={},a[e]=f);a=f}return a[b.shift()]=c}function ub(a){var b=vb[a];if(b)return b;var c="var l, fn, t;\n";k(a.split("."),function(a){a=wb[a]?'["'+a+'"]':"."+a;c+="if(!s) return s;\nl=s;\ns=s"+a+';\nif(typeof s=="function" && !(s instanceof RegExp)) s = function(){ return l'+
...
l++}d=Va[b];r.push({index:c,text:b,json:d,fn:d||n(ub(b),{assign:function(a,c){return Sa(a,b,c)}})})}function v(b){var c=l;l++;for(var d="",e=b,f=!1;l<a.length;){var g=a.charAt(l);e+=g;if(f)g=="u"?(g=a.substring(l+1,l+5),g.match(/[\da-f]{4}/i)||h("Invalid unicode escape [\\u"+g+"]"),l+=4,d+=String.fromCharCode(parseInt(g,16))):(f=pc[g],d+=f?f:g),f=!1;else if(g=="\\")f=!0;else if(g==b){l++;r.push({index:c,text:e,string:d,json:!0,fn:function(){return d.length==p?u.String.toDate(d):d}});return}else d+=
g;l++}h("Unterminated quote",c)}for(var p=b?sb:-1,r=[],y,l=0,k=[],t,U=":";l<a.length;){t=a.charAt(l);if(c("\"'"))v(t);else if(e(t)||c(".")&&e(d()))i();else if(f(t)){if(j(),"{,".indexOf(U)!=-1&&k[0]=="{"&&(y=r[r.length-1]))y.json=y.text.indexOf(".")==-1}else if(c("(){}[].,;:"))r.push({index:l,text:t,json:":[,".indexOf(U)!=-1&&c("{[")||c("}]:,")}),c("{[")&&k.unshift(t),c("}]")&&k.shift(),l++;else if(t==" "||t=="\r"||t=="\t"||t=="\n"||t=="\u000b"||t=="\u00a0"){l++;continue}else{var ka=t+d(),o=Va[t],
q=Va[ka];q?(r.push({index:l,text:ka,fn:q}),l+=2):o?(r.push({index:l,text:t,fn:o,json:"[,:".indexOf(U)!=-1&&c("+-")}),l+=1):h("Unexpected next character ",l,l+1)}U=t}return r}function da(a,b){function c(b,c){throw K("Parse Error: Token '"+c.text+"' "+b+" at column "+(c.index+1)+" of expression ["+a+"] starting at ["+a.substring(c.index)+"].");}function d(){if(s.length===0)throw K("Unexpected end of expression: "+a);return s[0]}function e(a,b,c,d){if(s.length>0){var e=s[0],g=e.text;if(g==a||g==b||g==
...
validator:function(){return G(Wa)},formatter:function(){function a(b){return function(a,c){for(var d=[c],g=0;g<e.length;g++)d.push(e[g](a));return b.apply(a,d)}}var b=f(),d=Y[b.text],e=[];for(d||c("is not a valid formatter.",b);;)if(b=f(":"))e.push(m());else return ua({format:a(d.format),parse:a(d.parse)})},filter:p,watch:function(){for(var a=[];s.length>0;)a.push(w()),f(";")||j();j();return function(b){for(var c=0;c<a.length;c++){var d=a[c](b);b.addListener(d.name,d.fn)}}}}}function Ab(a,b){this.template=
a+="#";this.defaults=b||{};var c=this.urlParams={};k(a.split(/\W/),function(b){b&&a.match(RegExp(":"+b+"\\W"))&&(c[b]=!0)})}function ya(a){this.xhr=a}function rc(a,b,c,d,e){function f(a){try{a.apply(null,ba.call(arguments,1))}finally{if(v--,v===0)for(;p.length;)try{p.pop()()}catch(b){e.error(b)}}}var g=this,h=a.location,i=a.setTimeout;g.isMock=!1;var j=0,v=0,p=[];g.xhr=function(b,e,g,i,h){v++;if(D(b)=="json"){var p=("angular_"+Math.random()+"_"+j++).replace(/\d\./,""),r=o("<script>").attr({type:"text/javascript",
src:e.replace("JSON_CALLBACK",p)});a[p]=function(b){a[p]=E;r.remove();f(i,200,b)};c.append(r)}else{var l=new d;l.open(b,e,!0);k(n({},Bb.DEFAULT,Bb[za(b)]||{},h||{}),function(a,b){a&&l.setRequestHeader(b,a)});l.onreadystatechange=function(){l.readyState==4&&f(i,l.status||200,l.responseText)};l.send(g||"")}};g.notifyWhenNoOutstandingRequests=function(a){v===0?a():p.push(a)};var r=[];g.poll=function(){k(r,function(a){a()})};g.addPollFn=function(a){r.push(a);return a};g.startPoller=function(a,b){(function qc(){g.poll();
b(qc,a)})()};g.setUrl=function(a){h.href.match(/#/);a.match(/#/)||(a+="#");h.href=a};g.getUrl=function(){return h.href};g.onHashChange=function(b){if("onhashchange"in a)o(a).bind("hashchange",b);else{var c=g.getUrl();g.addPollFn(function(){c!=g.getUrl()&&(b(),c=g.getUrl())})}return b};var y=b[0],l={},Ta="";g.cookies=function(a,b){var c,d,g,f;if(a)if(b===E)y.cookie=escape(a)+"=;expires=Thu, 01 Jan 1970 00:00:00 GMT";else{if(w(b))y.cookie=escape(a)+"="+escape(b),c=a.length+b.length+1,c>4096&&e.warn("Cookie '"+
a+"' possibly not set or overflowed because it was too large ("+c+" > 4096 bytes)!"),l.length>20&&e.warn("Cookie '"+a+"' possibly not set or overflowed because too many cookies were already set ("+l.length+" > 20 )")}else{if(y.cookie!==Ta){Ta=y.cookie;c=Ta.split("; ");l={};for(g=0;g<c.length;g++)d=c[g],f=d.indexOf("="),f>0&&(l[unescape(d.substring(0,f))]=unescape(d.substring(f+1)))}return l}};g.defer=function(a,b){v++;i(function(){f(a)},b||0)};var t=q;g.hover=function(a){t=a};g.bind=function(){b.bind("mouseover",
function(a){t(o(S?a.srcElement:a.target),!0);return!0});b.bind("mouseleave mouseout click dblclick keypress keyup",function(a){t(o(a.target),!1);return!0})};g.addCss=function(a){var b=o(y.createElement("link"));b.attr("rel","stylesheet");b.attr("type","text/css");b.attr("href",a);c.append(b)};g.addJs=function(a,b){var d=o(y.createElement("script"));d.attr("type","text/javascript");d.attr("src",a);b&&d.attr("id",b);c.append(d)}}function hb(a,b){function c(a,c,e,f){c=D(c);if(Cb[c])for(;g.last()&&Db[g.last()];)d("",
g.last());Eb[c]&&g.last()==c&&d("",c);(f=Fb[c]||!!f)||g.push(c);var h={};e.replace(sc,function(a,b,c,d,e){h[b]=Xa(c||d||e||"")});b.start&&b.start(c,h,f)}function d(a,c){var d=0,e;if(c=D(c))for(d=g.length-1;d>=0;d--)if(g[d]==c)break;if(d>=0){for(e=g.length-1;e>=d;e--)b.end&&b.end(g[e]);g.length=d}}var e,f,g=[],h=a;for(g.last=function(){return g[g.length-1]};a;){f=!0;if(!g.last()||!Gb[g.last()]){if(a.indexOf("<\!--")===0)e=a.indexOf("--\>"),e>=0&&(b.comment&&b.comment(a.substring(4,e)),a=a.substring(e+
3),f=!1);else if(tc.test(a)){if(e=a.match(Hb))a=a.substring(e[0].length),e[0].replace(Hb,d),f=!1}else if(uc.test(a)&&(e=a.match(Ib)))a=a.substring(e[0].length),e[0].replace(Ib,c),f=!1;f&&(e=a.indexOf("<"),f=e<0?a:a.substring(0,e),a=e<0?"":a.substring(e),b.chars&&b.chars(Xa(f)))}else a=a.replace(RegExp("(.*)<\\s*\\/\\s*"+g.last()+"[^>]*>","i"),function(a,c){c=c.replace(vc,"$1").replace(wc,"$1");b.chars&&b.chars(Xa(c));return""}),d("",g.last());if(a==h)throw"Parse Error: "+a;h=a}d()}function fa(a){var b=
{};a=a.split(",");var c;for(c=0;c<a.length;c++)b[a[c]]=!0;return b}function Xa(a){Ya.innerHTML=a.replace(/</g,"&lt;");return Ya.innerText||Ya.textContent||""}function Jb(a){return a.replace(/&/g,"&amp;").replace(xc,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ib(a){var b=!1,c=F(a,a.push);return{start:function(a,e,f){a=D(a);!b&&Gb[a]&&(b=a);!b&&Kb[a]==!0&&(c("<"),c(a),k(e,function(a,b){var d=D(b);if(yc[d]==!0&&(Lb[d]!==!0||a.match(zc)))c(" "),c(b),
c('="'),c(Jb(a)),c('"')}),c(f?"/>":">"))},end:function(a){a=D(a);!b&&Kb[a]==!0&&(c("</"),c(a),c(">"));a==b&&(b=!1)},chars:function(a){b||c(Jb(a))}}}function Ac(a){var b={};a=a[0].style;var c,d;if(typeof a.length=="number")for(c=0;c<a.length;c++)d=a[c],b[d]=a[d];else for(d in a)c=a[d],1*d!=d&&d!="cssText"&&c&&typeof c=="string"&&c!="false"&&(b[d]=c);return b}function Oa(a){if(w(a)&&a.charAt(0)!="<")throw new K("selectors not implemented");return new V(a)}function V(a){if(a instanceof V)return a;else if(w(a)){var b=
L.createElement("div");b.innerHTML="<div>&nbsp;</div>"+a;b.removeChild(b.firstChild);Za(this,b.childNodes);this.remove()}else Za(this,a)}function ra(a){Mb(a);var b=0;for(a=a.childNodes||[];b<a.length;b++)ra(a[b])}function Mb(a){var b=a[Aa],c=Ba[b];c&&(k(c.bind||{},function(b,c){Bc(a,c,b)}),delete Ba[b],a[Aa]=E)}function $a(a,b,c){var d=a[Aa];d=Ba[d||-1];if(x(c))d||(a[Aa]=d=Cc++,d=Ba[d]={}),d[b]=c;else return d?d[b]:null}function ab(a,b){var c;return(" "+a.className+" ").replace(/[\n\t]/g," ").indexOf(" "+
b+" ")>-1}function Nb(a,b){a.className=ia((" "+a.className+" ").replace(/[\n\t]/g," ").replace(" "+b+" ",""))}function Ob(a,b){if(!ab(a,b))a.className=ia(a.className+" "+b)}function Za(a,b){if(b){b=!b.nodeName&&x(b.length)&&(!b||!b.document||!b.location||!b.alert||!b.setInterval)?b:[b];for(var c=0;c<b.length;c++)a.push(b[c])}}function ga(a,b){u[a]=u[a]||{};k(b,function(b){n(u[a],b)})}function O(a,b,c){var d="";a<0&&(d="-",a=-a);for(a=""+a;a.length<b;)a="0"+a;c&&(a=a.substr(a.length-b));return d+a}
function G(a,b,c,d){return function(e){e=e["get"+a]();if(c>0||e>-c)e+=c;e===0&&c==-12&&(e=12);return O(e,b,d)}}function ha(a,b){return{format:a,parse:b||a}}function Pb(a){return x(a)&&a!==null?""+a:a}function bb(a){function b(){d=!1;c.$eval()}var c=this,d;return a.isMock?b:function(){d||(d=!0,a.defer(b,bb.delay))}}function Qb(a){var b=Rb[a];if(!b){var c=[];k(Ca(a),function(a){var b=Da(a);c.push(b?function(a){var c,d=this.$tryEval(b,function(a){c=M(a)});aa(a,xa,c);return c?c:d}:function(){return a})});
Rb[a]=b=function(a,b){var f=[],g=this.hasOwnProperty(Sb)?this.$element:E;this.$element=a;for(var h=0;h<c.length;h++){var i=c[h].call(this,a);i&&(i.nodeName||i.bind&&i.find)?i="":I(i)&&(i=M(i,b));f.push(i)}this.$element=g;return f.join("")}}return b}function cb(a){return function(b,c){var d=c[0].className+" ";return function(c){this.$onEval(function(){if(a(this.$index)){var f=this.$eval(b);Q(f)&&(f=f.join(" "));c[0].className=ia(d+f)}},c)}}}function Ca(a){for(var b=[],c=0,d;(d=a.indexOf("{{",c))>-1;)c<
d&&b.push(a.substr(c,d-c)),c=d,d=a.indexOf("}}",d),d=d<0?a.length:d+2,b.push(a.substr(c,d-c)),c=d;c!=a.length&&b.push(a.substr(c,a.length-c));return b.length===0?[a]:b}function Da(a){return(a=a.replace(/\n/gm," ").match(/^\{\{(.*)\}\}$/))?a[1]:null}function sa(a,b){var c=b.attr("name"),d;if(c){d=da(c).assignable().assign;if(!d)throw new K("Expression '"+c+"' is not assignable.");return{get:function(){return a.$eval(c)},set:function(c){if(c!==E)return a.$tryEval(function(){d(a,c)},b)}}}}function db(a,
b){var c=sa(a,b),d=b.attr("ng:format")||Ea,e=da(d).formatter()();if(c)return{get:function(){return e.format(a,c.get())},set:function(b){return c.set(e.parse(a,b))}}}function eb(a,b){function c(){var c=ia(b.val());if(b[0].disabled||b[0].readOnly)aa(b,ta,null),p.markValid(b);else{var d=Zb(a,{$element:b});c=v&&!c?"Required":c?e(d,c):null;aa(b,ta,c);(j=c)?p.markInvalid(b):p.markValid(b)}}var d=b.attr("ng:validate")||Ea,e=da(d).validator()(),f=b.attr("ng:required"),g=b.attr("ng:format")||Ea;g=da(g).formatter()();
var h,i,j,v,p=a.$service("$invalidWidgets")||{markValid:q,markInvalid:q};if(!e)throw"Validator named '"+d+"' not found.";h=g.format;i=g.parse;f?a.$watch(f,function(a){v=a;c()}):v=f==="";b.data(fb,c);return{get:function(){j&&aa(b,ta,null);try{var d=i(a,b.val());c();return d}catch(e){j=e,aa(b,ta,e)}},set:function(d){var e=b.val();d=h(a,d);e!=d&&b.val(d||"");c()}}}function Tb(a,b){var c=b.attr("ng:format")||Ea,d=da(c).formatter()();return{get:function(){var c=[];k(b[0].options,function(b){b.selected&&
c.push(d.parse(a,b.value))});return c},set:function(c){var f={};k(c,function(b){f[d.format(a,b)]=!0});k(b[0].options,function(a){a.selected=f[a.value]})}}}function Ub(){return{get:q,set:q}}function Fa(a){return function(b,c){var d=c.get();!d&&x(a)&&(d=A(a));z(b.get())&&x(d)&&b.set(d)}}function la(a,b,c,d,e){return n(function(f,g,h){var i=this,j=b(i,h),v=c(i,h),p=h.attr("ng:change")||"",r;j&&(d.call(i,j,v,h),this.$eval(h.attr("ng:init")||""),h.bind(a,function(a){function b(){var a=v.get();if(!e||a!=
r)j.set(a),r=j.get(),i.$tryEval(p,h),f()}a.type=="keydown"?g(b):b()}),i.$watch(j.get,function(a){r!==a&&v.set(r=a)}))},{$inject:["$updateView","$defer"]})}function Ga(a){this.directives(!0);this.descend(!0);return Dc[D(a[0].type)]||q}if(typeof L.getAttribute==$)L.getAttribute=function(){};var D=function(a){return w(a)?a.toLowerCase():a},za=function(a){return w(a)?a.toUpperCase():a},Sb="$element",fb="$validate",hc="boolean",R="function",Xb="length",Yb="name",wa="null",ac="number",gb="object",$b="string",
$="undefined",xa="ng-exception",ta="ng-validation-error",Ea="noop",yb=-1E3,Ec={FIRST:-99999,LAST:99999,WATCH:yb},K=s.Error,S=parseInt((/msie (\d+)/.exec(D(navigator.userAgent))||[])[1],10),o,Na,ba=[].slice,H=[].push,gc=s.console?F(s.console,s.console.error||q):q,u=s.angular||(s.angular={}),Ka=P(u,"markup"),nb=P(u,"attrMarkup"),B=P(u,"directive"),J=P(u,"widget",D),Wa=P(u,"validator"),N=P(u,"filter"),Y=P(u,"formatter"),Ua=P(u,"service");P(u,"callbacks");var pa,fc=/^(|.*\/)angular(-.*?)?(\.min)?.js(\?[^#]*)?(#(.*))?$/,
sb=24;pa=S<9?function(a){a=a.nodeName?a:a[0];return a.scopeName&&a.scopeName!="HTML"?za(a.scopeName+":"+a.nodeName):a.nodeName}:function(a){return a.nodeName?a.nodeName:a[0].nodeName};u.toJson=M;u.fromJson=ca;Ra.prototype={attach:function(a,b){var c={};this.collectInits(a,c,b);Ha(c,function(a){k(a,function(a){a()})})},collectInits:function(a,b,c){var d=b[this.priority],e=c;d||(b[this.priority]=d=[]);this.newScope&&(e=T(c),c.$onEval(e.$eval),a.data("$scope",e));k(this.inits,function(b){d.push(function(){e.$tryEval(function(){return e.$service(b,
e,a)},a)})});var f=a[0].childNodes,g=this.children,h=this.paths,i=h.length;for(c=0;c<i;c++)g[c].collectInits(o(f[h[c]]),b,e)},addInit:function(a){a&&this.inits.push(a)},addChild:function(a,b){b&&(this.paths.push(a),this.children.push(b))},empty:function(){return this.inits.length===0&&this.paths.length===0}};mb.prototype={compile:function(a){a=o(a);var b=0,c,d=a.parent();if(d&&d[0]){d=d[0];for(var e=0;e<d.childNodes.length;e++)d.childNodes[e]==a[0]&&(b=e)}c=this.templatize(a,b,0)||new Ra;return function(b,
d){var e=d?qb.clone.call(a):a;b=b||T();e.data("$scope",b);b.$element=e;(d||q)(e,b);c.attach(e,b);b.$eval();return b}},templatize:function(a,b,c){var d=this,e,f,g=d.directives,h=!0,i=!0,j=pa(a),v=j.indexOf(":")>0?D(j).replace(":","-"):"",p,r={compile:F(d,d.compile),descend:function(a){x(a)&&(h=a);return h},directives:function(a){x(a)&&(i=a);return i},scope:function(a){if(x(a))p.newScope=p.newScope||a;return p.newScope}};try{c=a.attr("ng:eval-order")||c||0}catch(y){c=c||0}a.addClass(v);w(c)&&(c=Ec[za(c)]||
parseInt(c,10));p=new Ra(c);va(a,function(b,c){if(!e&&(e=d.widgets("@"+c)))a.addClass("ng-attr-widget"),e=F(r,e,b,a)});if(!e&&(e=d.widgets(j)))v&&a.addClass("ng-widget"),e=F(r,e,a);e&&(i=h=!1,j=a.parent(),p.addInit(e.call(r,a)),j&&j[0]&&(a=o(j[0].childNodes[b])));if(h)for(var l=0,n=a[0].childNodes;l<n.length;l++)pa(n[l])=="#text"&&k(d.markup,function(b){if(l<n.length){var c=o(n[l]);b.call(r,c.text(),c,a)}});i&&(va(a,function(b,c){k(d.attrMarkup,function(d){d.call(r,b,c,a)})}),va(a,function(b,c){if(f=
g[c])a.addClass("ng-directive"),p.addInit(g[c].call(r,b,a))}));h&&tb(a,function(a,b){p.addChild(b,d.templatize(a,b,c))});return p.empty()?null:p}};var ic=0,vb={},xb={},wb={};k("abstract,boolean,break,byte,case,catch,char,class,const,continue,debugger,default,delete,do,double,else,enum,export,extends,false,final,finally,float,for,function,goto,if,implements,import,ininstanceof,intinterface,long,native,new,null,package,private,protected,public,return,short,static,super,switch,synchronized,this,throw,throws,transient,true,try,typeof,var,volatile,void,undefined,while,with".split(/,/),
function(a){wb[a]=!0});var lc=/^function\s*[^\(]*\(([^\)]*)\)/,mc=/,/,nc=/^\s*(((\$?).+?)(_?))\s*$/,kc=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Va={"null":function(){return null},"true":function(){return!0},"false":function(){return!1},$undefined:q,"+":function(a,b,c){return(x(b)?b:0)+(x(c)?c:0)},"-":function(a,b,c){return(x(b)?b:0)-(x(c)?c:0)},"*":function(a,b,c){return b*c},"/":function(a,b,c){return b/c},"%":function(a,b,c){return b%c},"^":function(a,b,c){return b^c},"=":q,"==":function(a,b,c){return b==
c},"!=":function(a,b,c){return b!=c},"<":function(a,b,c){return b<c},">":function(a,b,c){return b>c},"<=":function(a,b,c){return b<=c},">=":function(a,b,c){return b>=c},"&&":function(a,b,c){return b&&c},"||":function(a,b,c){return b||c},"&":function(a,b,c){return b&c},"|":function(a,b,c){return c(a,b)},"!":function(a,b){return!b}},pc={n:"\n",f:"\u000c",r:"\r",t:"\t",v:"\u000b","'":"'",'"':'"'};Ab.prototype={url:function(a){var b=this,c=this.template,d;a=a||{};k(this.urlParams,function(e,g){d=Ma(a[g]||
b.defaults[g]||"",!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+");c=c.replace(RegExp(":"+g+"(\\W)"),d+"$1")});c=c.replace(/\/?#$/,"");var e=[];Ha(a,function(a,c){b.urlParams[c]||e.push(Ma(c)+"="+Ma(a))});c=c.replace(/\/*$/,"");return c+(e.length?"?"+e.join("&"):"")}};ya.DEFAULT_ACTIONS={get:{method:"GET"},save:{method:"POST"},query:{method:"GET",isArray:!0},remove:{method:"DELETE"},"delete":{method:"DELETE"}};ya.prototype={route:function(a,b,c){function d(a){var c={};k(b||{},function(b,
...
arguments.length+" arguments.";}e[i].call(this,c,j?this:E,g)}});return e}};var Fc=s.XMLHttpRequest||function(){try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(a){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(b){}try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){}throw new K("This browser does not support XMLHttpRequest.");},Bb={DEFAULT:{Accept:"application/json, text/plain, */*","X-Requested-With":"XMLHttpRequest"},POST:{"Content-Type":"application/x-www-form-urlencoded"}},
Ib=/^<\s*([\w:-]+)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*>/,Hb=/^<\s*\/\s*([\w:-]+)[^>]*>/,sc=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,uc=/^</,tc=/^<\s*\//,vc=/<\!--(.*?)--\>/g,wc=/<!\[CDATA\[(.*?)]]\>/g,zc=/^((ftp|https?):\/\/|mailto:|#)/,xc=/([^\#-~| |!])/g,Fb=fa("area,br,col,hr,img"),Cb=fa("address,blockquote,center,dd,del,dir,div,dl,dt,hr,ins,li,map,menu,ol,p,pre,script,table,tbody,td,tfoot,th,thead,tr,ul"),Db=fa("a,abbr,acronym,b,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var"),
Eb=fa("colgroup,dd,dt,li,p,td,tfoot,th,thead,tr"),Gb=fa("script,style"),Kb=n({},Fb,Cb,Db,Eb),Lb=fa("background,href,longdesc,src,usemap"),yc=n({},Lb,fa("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,span,start,summary,target,title,type,valign,value,vspace,width")),Ya=L.createElement("pre"),Ba={},Aa="ng-"+(new Date).getTime(),
...
b);Oa(s).bind("load",b)},toString:function(){var a=[];k(this,function(b){a.push(""+b)});return"["+a.join(", ")+"]"},length:0,push:H,sort:[].sort,splice:[].splice};k({data:$a,scope:function(a){for(var b;a&&!(b=o(a).data("$scope"));)a=a.parentNode;return b},removeAttr:function(a,b){a.removeAttribute(b)},hasClass:ab,css:function(a,b,c){if(x(c))a.style[b]=c;else return a.style[b]},attr:function(a,b,c){if(x(c))a.setAttribute(b,c);else if(a.getAttribute)return a.getAttribute(b,2)},text:n(S<9?function(a,
...
b,d)}else{for(e=0;e<this.length;e++)a(this[e],b,d);return this}return a.$dv}});k({removeData:Mb,dealoc:ra,bind:function(a,b,c){var d=$a(a,"bind"),e;d||$a(a,"bind",d={});k(b.split(" "),function(b){e=d[b];if(!e)d[b]=e=function(b){if(!b.preventDefault)b.preventDefault=function(){b.returnValue=!1};if(!b.stopPropagation)b.stopPropagation=function(){b.cancelBubble=!0};k(e.fns,function(c){c.call(a,b)})},e.fns=[],Gc(a,b,e);e.fns.push(c)})},replaceWith:function(a,b){var c,d=a.parentNode;ra(a);k(new V(b),function(b){c?
d.insertBefore(b,c.nextSibling):d.replaceChild(b,a);c=b})},children:function(a){var b=[];k(a.childNodes,function(a){a.nodeName!="#text"&&b.push(a)});return b},append:function(a,b){k(new V(b),function(b){a.nodeType===1&&a.appendChild(b)})},remove:function(a){ra(a);var b=a.parentNode;b&&b.removeChild(a)},after:function(a,b){var c=a,d=a.parentNode;k(new V(b),function(a){d.insertBefore(a,c.nextSibling);c=a})},addClass:Ob,removeClass:Nb,toggleClass:function(a,b,c){z(c)&&(c=!ab(a,b));(c?Ob:Nb)(a,b)},parent:function(a){return(a=
a.parentNode)&&a.nodeType!==11?a:null},next:function(a){return a.nextSibling},find:function(a,b){return a.getElementsByTagName(b)},clone:function(a){return a.cloneNode(!0)}},function(a,b){V.prototype[b]=function(b,d){for(var e,f=0;f<this.length;f++)e==E?(e=a(this[f],b,d),e!==E&&(e=o(e))):Za(e,a(this[f],b,d));return e==E?this:e}});H={typeOf:function(a){if(a===null)return wa;var b=typeof a;if(b==gb){if(a instanceof Array)return"array";if(a instanceof Date)return"date";if(a.nodeType==1)return"element"}return b}};
...
function(){var a=0;k(b,function(b){var e=a;b=b[0].getBoundingClientRect();var f=b.height||b.bottom||0-b.top||0;a=e+((b.width||b.right||0-b.left||0)>0&&f>0?1:0)});return a};this.$onEval(99999,function(){for(var c=0;c<b.length;){var d=b[c];a(d[0])?(b.splice(c,1),d.dealoc&&d.dealoc()):c++}});return b});var Oc=/^(file|ftp|http|https):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/,Pc=/^([^\?]*)?(\?([^\?]*))?$/,Wb={http:80,https:443,ftp:21};C("$location",function(a){function b(a){if(w(a)){var b=
n,c=i,d={},h=Oc.exec(a);if(h)d.href=a.replace(/#$/,""),d.protocol=h[1],d.host=h[3]||"",d.port=h[5]||Wb[d.protocol]||null,d.path=h[6]||"",d.search=La(h[8]),d.hash=h[10]||"",n(d,g(d.hash));b(c,d)}else{x(a.hash)&&n(a,w(a.hash)?g(a.hash):a.hash);n(i,a);if(x(a.hashPath||a.hashSearch))i.hash=f(i);i.href=e(i)}}function c(a,c){var d={};w(a)?(d.hashPath=a,d.hashSearch=c||{}):d.hashSearch=a;d.hash=f(d);b({hash:d})}function d(){if(!oa(i,j)){if(i.href==j.href)if(i.hash!=j.hash){var a=g(i.hash);c(a.hashPath,a.hashSearch)}else i.hash=
f(i),i.href=e(i);b(i.href)}}function e(a){var b=ob(a.search),c=a.port==Wb[a.protocol]?null:a.port;return a.protocol+"://"+a.host+(c?":"+c:"")+a.path+(b?"?"+b:"")+(a.hash?"#"+a.hash:"")}function f(a){var b=ob(a.hashSearch);return escape(a.hashPath).replace(/%21/gi,"!").replace(/%3A/gi,":").replace(/%24/gi,"$")+(b?"?"+b:"")}function g(a){var b={},c=Pc.exec(a);if(c)b.hash=a,b.hashPath=unescape(c[1]||""),b.hashSearch=La(c[3]);return b}var h=this,i={update:b,updateHash:c},j={};a.onHashChange(function(){b(a.getUrl());
A(i,j);h.$eval()})();this.$onEval(-99999,d);this.$onEval(99999,function(){d();a.getUrl()!=i.href&&(a.setUrl(i.href),A(i,j))});return i},["$browser"]);C("$log",function(a){function b(b){var d=a.console||{},e=d[b]||d.log||q;return e.apply?function(){var a=[];k(arguments,function(b){a.push(Ia(b))});return e.apply(d,a)}:e}return{log:b("log"),warn:b("warn"),info:b("info"),error:b("error")}},["$window"]);C("$resource",function(a){a=new ya(a);return F(a,a.route)},["$xhr.cache"]);C("$route",function(a,b){var c=
...
return}g=T(f);h.current=n({},j,{scope:g,params:n({},a.hashSearch,v)})}k(d,f.$tryEval);g&&g.$become(h.current.controller)});return h},["$location","$updateView"]);bb.delay=25;C("$updateView",bb,["$browser"]);C("$window",F(s,Z,s));C("$xhr.bulk",function(a,b,c){function d(b,c,e,i){m(e)&&(i=e,e=null);var j;k(d.urls,function(a){if(m(a.match)?a.match(c):a.match.exec(c))j=a});if(j){if(!j.requests)j.requests=[];j.requests.push({method:b,url:c,data:e,callback:i})}else a(b,c,e,i)}var e=this;d.urls={};d.flush=
...
a+"' controller.";if(!m(b))throw"Reference '"+a+"' is not a class.";this.$become(b)}});B("ng:eval",function(a){return function(b){this.$onEval(a,b)}});B("ng:bind",function(a,b){b.addClass("ng-binding");return function(b){var d=q,e=q;this.$onEval(function(){var f,g,h,i,j;i=this.hasOwnProperty(Sb)?this.$element:E;this.$element=b;g=this.$tryEval(a,function(a){f=Ia(a)});this.$element=i;if(i=g instanceof Ja)g=(h=g).html;if(!(d===g&&e==f)&&(j=g&&(g.nodeName||g.bind&&g.find),!i&&!j&&I(g)&&(g=M(g,!0)),g!=
d||f!=e))d=g,e=f,aa(b,xa,f),f&&(g=f),i?b.html(h.get()):j?(b.html(""),b.append(g)):b.text(g==E?"":g)},b)}});var Rb={};B("ng:bind-template",function(a,b){b.addClass("ng-binding");var c=Qb(a);return function(a){var b;this.$onEval(function(){var f=c.call(this,a,!0);f!=b&&(a.text(f),b=f)},a)}});var Qc={disabled:"disabled",readonly:"readOnly",checked:"checked",selected:"selected"};B("ng:bind-attr",function(a){return function(b){var c={},d=b.data("$update")||q;this.$onEval(function(){var e=this.$eval(a),
f=q,g;for(g in e){var h=Qb(e[g]).call(this,b),i=Qc[D(g)];c[g]!==h&&(c[g]=h,i?(ja(h)?(b.attr(i,i),b.attr("ng-"+i,h)):(b.removeAttr(i),b.removeAttr("ng-"+i)),(b.data(fb)||q)()):b.attr(g,h),f=d)}f()},b)}});B("ng:click",function(a){return n(function(b,c){var d=this;c.bind("click",function(e){d.$tryEval(a,c);b();e.stopPropagation()})},{$inject:["$updateView"]})});B("ng:submit",function(a){return n(function(b,c){var d=this;c.bind("submit",function(e){d.$tryEval(a,c);b();e.preventDefault()})},{$inject:["$updateView"]})});
B("ng:class",cb(function(){return!0}));B("ng:class-odd",cb(function(a){return a%2===0}));B("ng:class-even",cb(function(a){return a%2===1}));B("ng:show",function(a){return function(b){this.$onEval(function(){b.css("display",ja(this.$eval(a))?"":"none")},b)}});B("ng:hide",function(a){return function(b){this.$onEval(function(){b.css("display",ja(this.$eval(a))?"none":"")},b)}});B("ng:style",function(a){return function(b){var c=Ac(b);this.$onEval(function(){var d=this.$eval(a)||{},e,f={};for(e in d)c[e]===
E&&(c[e]=""),f[e]=d[e];for(e in c)f[e]=f[e]||c[e];b.css(f)},b)}});Ka("{{}}",function(a,b,c){var d=Ca(a);if(d.length>1||Da(d[0])!==null)if(cc(c[0]))c.attr("ng:bind-template",a);else{var e=b,f;k(Ca(a),function(a){var b=Da(a);b?(f=o("<span>"),f.attr("ng:bind",b)):f=o(L.createTextNode(a));S&&a.charAt(0)==" "&&(f=o("<span>&nbsp;</span>"),b=f.html(),f.text(a.substr(1)),f.html(b+f.html()));e.after(f);e=f});b.remove()}});Ka("option",function(a,b,c){D(pa(c))=="option"&&(S<=7?hb(c[0].outerHTML,{start:function(b,
e){z(e.value)&&c.attr("value",a)}}):c[0].getAttribute("value")==null&&c.attr("value",a))});var Rc={"ng:src":"src","ng:href":"href"};nb("{{}}",function(a,b,c){if(!B(b)&&!B("@"+b)){S&&b=="src"&&(a=decodeURI(a));var d=Ca(a);if(d.length>1||Da(d[0])!==null)c.removeAttr(b),d=ca(c.attr("ng:bind-attr")||"{}"),d[Rc[b]||b]=a,c.attr("ng:bind-attr",M(d))}});H=la("keydown change",sa,eb,Fa(),!0);W=la("click",Ub,Ub,q);var Dc={text:H,textarea:H,hidden:H,password:H,button:W,submit:W,reset:W,image:W,checkbox:la("click",
db,function(a,b){var c=b[0];return{get:function(){return!!c.checked},set:function(a){c.checked=ja(a)}}},Fa(!1)),radio:la("click",db,function(a,b){var c=b[0];return{get:function(){return c.checked?c.value:null},set:function(a){c.checked=a==c.value}}},function(a,b,c){var d=a.get(),e=b.get();c=c[0];c.checked=!1;c.name=this.$id+"@"+c.name;z(d)&&a.set(d=null);d==null&&e!==null&&a.set(e);b.set(d)}),"select-one":la("change",sa,eb,Fa(null)),"select-multiple":la("change",sa,Tb,Fa([]))};J("input",Ga);J("textarea",
Ga);J("button",Ga);J("select",function(a){this.descend(!0);return Ga.call(this,a)});J("option",function(){this.descend(!0);this.directives(!0);return function(a){var b=a.parent(),c=b[0].type=="select-multiple",d=b.scope(),e=sa(d,b);if(e){var f=db(d,b),g=c?Tb(d,b):eb(d,b),h=a.attr("value"),i=a.attr("ng-selected");a.data("$update",c?function(){g.set(e.get())}:function(){var b=a.attr("value"),c=a.attr("ng-selected"),d=e.get();if(i!=c||h!=b)i=c,h=b,(c||!d==null||d==E)&&f.set(b),b==d&&g.set(h)})}}});J("ng:include",
